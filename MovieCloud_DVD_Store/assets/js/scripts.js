...
jQuery(document).ready(function() {
    ...
    */
	...
	$('#newusername').blur(function(){
	    var checkString = $("#newusername").val();
			...
			$.ajax({
				...
				success: function(msg){
					if(msg=='Yes')
					{
						...
						{
							$('.register form').find("label[for='newusername']").append("<span style='display:none' class='red usercheck'> - Username already exists.</span>");
							$('.register form').find("label[for='newusername'] span").fadeIn('medium');
						}
					}
					else
					{
